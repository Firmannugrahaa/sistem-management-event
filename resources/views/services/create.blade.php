<x-app-layout>
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400">Tambahkan layanan baru yang tersedia untuk vendor</p>
    </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow mb-6">
            ...
            <div class="mt-6">
                ...
                <textarea name="description" id="description"
                          rows="3"
                          class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
