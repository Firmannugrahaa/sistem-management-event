            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    @if($clientRequest->event_type == 'Wedding')
                        <div class="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-xl p-6 flex items-center justify-between gap-4">
                            ...
                            <a href="{{ route('client.checklist', $clientRequest) }}" class="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition font-semibold shadow-sm whitespace-nowrap">
                                Lihat Checklist →
                            </a>
                        </div>
                    @endif
