        ...
        <div class="container mx-auto flex justify-between items-center">
            <div class="flex items-center">
                <a href="/" class="flex items-center gap-3">
                    ...
                    <div>
                        <span class="text-xl font-bold text-[#8B8680]">Lorem Ipsum</span>
    ...
    <footer class="bg-[#8B8680] text-white py-12 mt-16">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="md:col-span-2">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold">PT. Lorem Ipsum</h3>
            ...
            <div class="mt-8 pt-8 border-t border-white/20 text-center text-gray-300 text-sm">
                &copy; {{ date('Y') }} PT. Lorem Ipsum. All rights reserved. | Designed with <span class="text-[#F4A6A0]">♥</span> for memorable events.
            </div>
        </div>
    </footer>
    <x-loading />
