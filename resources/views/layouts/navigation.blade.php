    ...
    <div class="flex flex-col h-full">
        ...
        <div class="flex-1 flex flex-col justify-between py-6 px-2 overflow-y-auto">
            <div class="space-y-2">
                ...
                <!-- Manage Team/Vendor Dropdown (for Owners and Admins) -->
                @canany(['team_member.read', 'team_member.create', 'team_member.update', 'team_member.delete', 'team_member.approve', 'vendor.read', 'vendor.create', 'vendor.update', 'vendor.delete', 'vendor.approve'])
                <div x-data="{ open: {{ request()->routeIs('team-vendor.*') || request()->routeIs('team.*') || request()->routeIs('vendors.*') || request()->routeIs('team-vendor.management') ? 'true' : 'false' }} }" class="relative">
                    <button @click="open = !open"
                        class="flex items-center gap-3 px-4 py-3 rounded-lg transition duration-200 hover:bg-[#F0F0F0] hover:text-black w-full text-left {{ request()->routeIs('team-vendor.*') || request()->routeIs('team.*') || request()->routeIs('vendors.*') || request()->routeIs('team-vendor.management') ? 'bg-[#012A4A] text-white' : 'text-[#1A1A1A]' }}">
                        <svg class="w-6 h-6 flex-shrink-0 p-1 rounded {{ request()->routeIs('team-vendor.*') || request()->routeIs('team.*') || request()->routeIs('vendors.*') || request()->routeIs('team-vendor.management') ? 'bg-[#c1dfeb] text-[#012A4A]' : 'bg-[#012A4A] text-white' }}" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100"
                        ...
                        <a href="{{ route('team-vendor.management') }}"
                            class="flex items-center gap-3 px-4 py-3 rounded-lg transition duration-200 hover:bg-[#F0F0F0] hover:text-black {{ request()->routeIs('team-vendor.management') ? 'bg-[#012A4A] text-white' : 'text-[#1A1A1A]' }}">
                            <span class="text-sm font-medium" x-show="open" x-transition>Team & Vendor Management</span>
                        </a>
                        <a href="{{ route('team-vendor.index', ['view' => 'team']) }}"
                            ...
                            <span class="text-sm font-medium" x-show="open" x-transition>Legacy Team Members</span>
                        </a>
                        <a href="{{ route('team-vendor.index', ['view' => 'vendor']) }}"
                            ...
                            <span class="text-sm font-medium" x-show="open" x-transition>Legacy Vendors</span>
                        </a>
                    </div>
                </div>
                @endcanany
