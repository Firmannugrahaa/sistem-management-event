        ...
        <div class="flex-1 flex flex-col justify-between py-6 px-2">
            <div class="space-y-2">
                ...
                <a href="{{ route('client.dashboard') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg transition duration-200 hover:bg-[#F0F0F0] {{ request()->routeIs('client.*') ? 'bg-[#012A4A] text-white' : '' }}">
                    ...
                    <span class="text-sm font-medium" x-show="open" x-transition>My Requests</span>
                </a>
                @endif
                ...
                <!-- Client Requests / Leads (for internal users) -->
                @if(auth()->user()->hasAnyRole(['SuperUser', 'Owner', 'Admin', 'Staff', 'Vendor']))
                <a href="{{ route('client-requests.index') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg transition duration-200 hover:bg-[#F0F0F0] {{ request()->routeIs('client-requests.*') ? 'bg-[#012A4A] text-white' : 'text-[#1A1A1A]' }}">
                    <svg class="w-6 h-6 flex-shrink-0 p-1 rounded {{ request()->routeIs('client-requests.*') ? 'bg-[#c1dfeb] text-[#012A4A]' : 'bg-[#012A4A] text-white' }}" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <span class="text-sm font-medium" x-show="open" x-transition>Leads / Inbox</span>
                </a>
                @endif
                ...
                <a href="{{ route('admin.trash.index') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg transition duration-200 hover:bg-[#F0F0F0] {{ request()->routeIs('admin.trash.*') ? 'bg-[#012A4A] text-white' : 'text-[#1A1A1A]' }}">
                    <svg class="w-6 h-6 flex-shrink-0 p-1 rounded {{ request()->routeIs('admin.trash.*') ? 'bg-[#c1dfeb] text-[#012A4A]' : 'bg-[#012A4A] text-white' }}" width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                    </svg>
                    <span class="text-sm font-medium" x-show="open" x-transition>Trash Management</span>
                </a>
                @endif
