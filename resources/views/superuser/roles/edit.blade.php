...
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <form method="POST" action="{{ route('superuser.roles.update', $role) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-1">
                        <input type="text" name="name" id="name" value="{{ old('name', $role->name) }}" required class="py-2 px-3 block w-full shadow-sm focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-md @error('name') border-red-500 @enderror">
                    </div>
                    @error('name')
