<x-vendor-dashboard-layout>
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400">Edit detail layanan yang Anda sediakan</p>
    </div>
    ...
    <form method="POST" action="{{ route('vendor.services.update', $vendorService->pivot->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="number" name="price" id="price" 
                           value="{{ old('price', $vendorService->pivot->price ?: $service->price) }}"
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" 
                          rows="3"
                          class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary">{{ old('description', $vendorService->pivot->description ?: $service->description) }}</textarea>
            ...
            <div class="flex items-center">
                <input type="checkbox" name="is_available" id="is_available" 
                       value="1" 
                       {{ old('is_available', $vendorService->pivot->is_available) ? 'checked' : '' }}
