<x-app-layout>
    ...
    <div class="py-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6" x-data="{ activeTab: 'overview' }">
            <!-- Main Content with Tabs -->
            <div class="lg:col-span-3">
                <!-- Tab Navigation -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-2">
                    <div class="border-b border-gray-200">
                        <nav class="flex -mb-px" aria-label="Tabs">
                            ...
                            <button @click="activeTab = 'communication'" 
                                    :class="activeTab === 'communication' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                                    class="w-1/3 py-4 px-1 text-center border-b-2 font-medium text-sm transition-colors">
                                💬 Communication
                            </button>
                        </nav>
                ...
                <div class="space-y-6">
                    ...
                    <div x-show="activeTab === 'overview'" x-transition class="space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <dl class="grid grid-cols-1 md:grid-cols-3 gap-2">
                                <div>
                ...
                @endif
                    ...
                    <!-- Tab 3: Communication -->
                    <div x-show="activeTab === 'communication'" x-transition class="space-y-6">
                        <!-- Internal Notes -->
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
                            ...
                            <p class="text-sm text-gray-500">Belum ada catatan atau komunikasi</p>
                        </div>
                        @endif
                    </div>
